...
INSERT IGNORE INTO `videos` (`videoId`, `userId`, `link`, `title`, `description`, `views`, `postedByUsername`, `likes`, `dislikes`, `stars`) VALUES
	...
	(7, 8, 'test', 'xQc talks about the meaning of "juice"', 'ha', 5655123, 'xQc', 0, 0, 0),
