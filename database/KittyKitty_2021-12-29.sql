...
INSERT IGNORE INTO `users` (`userId`, `username`, `password`, `description`, `profileURL`, `subscribers`, `videosPosted`) VALUES
	...
	(8, 'xQc', '60ebf6e22afe105f975ddc810e6cac4599034f40cc25c16da279c36c2b4bcbbe', 'ha', 'https://www.bora.com/fileadmin/website_content/Erleben/Cooking/55_Team_Edition/Rezeptbilder/55_TeamEdition_Canada_Halloumi-Burger.jpg', 532000, 10);
...
-- Dumping data for table kittykitty.videos: ~5 rows (approximately)
/*!40000 ALTER TABLE `videos` DISABLE KEYS */;
INSERT IGNORE INTO `videos` (`videoId`, `userId`, `link`, `title`, `description`, `views`, `postedByUsername`) VALUES
	(2, 1, 'test', 'hah', 'yeah', 0, 'guy'),
	(4, 5, 'ye', 'HADOKEN', 'wwwwwww', 0, 'heheh'),
	(5, 2, 'qwerty', 'hatter', 'aaaaaaaaa', 0, 'haha'),
	(6, 3, 'uuuuuuuu', 'tttttt', 'bbbbb', 0, 'hah'),
	(7, 8, 'test', 'xQc talks about the meaning of "juice"', 'ha', 5655123, 'xQc');
