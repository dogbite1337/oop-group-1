...
-- Dumping data for table kittykitty.comments: ~6 rows (approximately)
...
INSERT IGNORE INTO `comments` (`commentId`, `relatesToVideoId`, `postedByUsername`, `content`, `likes`, `dislikes`, `responseToCommentId`, `timeOfPosting`) VALUES
	(165, 19, 'xQc', '1', 0, 0, -1, 1641862408879),
	(166, 19, 'xQc', '2', 1, 2, 165, 1641862412696),
	(167, 19, 'xQc', '3', 2, 2, 165, 1641862419199),
	(168, 19, 'xQc', 'h', 0, 3, 165, 1641862629408),
	(169, 19, 'xQc', '44', 0, 0, -1, 1641863184527),
	(170, 19, 'xQc', '33333333333333', 0, 0, 169, 1641863213679);
...
-- Dumping data for table kittykitty.videos: ~8 rows (approximately)
